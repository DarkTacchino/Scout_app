...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        button=findViewById(R.id.b_inserisci);
        listarichieste=findViewById(R.id.lista);

        citta=findViewById(R.id.editText_citta);
        citta.setText("");
    ...
    public void effettuaRichiesta(View view)
    {
        ...
        if(city.isEmpty())
        {
            toast = Toast.makeText(this,"Inserisci una città", Toast.LENGTH_LONG);
            toast.show();
        }
        else
        {
    ...
    private void getWeather(String city) {
        new Thread(() -> {
            try {
                ...
                String urlString = "https://wheather-webapp-emanuelepallot1.replit.app/weather?city=" +
                ...
                String temperatura = json.getString("temperatura");
            ...
            catch (Exception e)
            {
                runOnUiThread(() -> {
                    ...
                    Log.e("MainActivity", "Errore: " + e.getMessage());
                });
            }
        }).start();
    }
